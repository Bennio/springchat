package vn.edu.ifi.springchat.stringsimilarity;

import java.util.Arrays;

import vn.edu.ifi.springchat.stringsimilarity.interfaces.NormalizedStringDistance;
import vn.edu.ifi.springchat.stringsimilarity.interfaces.NormalizedStringSimilarity;
 ...
 * public static void main(String ...strings) {
	...
	System.out.println(j.distance("je suis sonfack", "je suis le sonfack"));
	System.out.println(j.distance("je suis sonfack", "je suis sonfack"));
	System.out.println(j.distance("je suis sonfack", "je suis le la sonfack"));
	System.out.println(j.distance("je suis sonfack", "je suis le une sonfack"));
